...
-------------------------------
	...
	First Chest is a set of 3D models, particles, textures and scripts that helps you quickly add and setup gifts, presents and treasure chests system for your project. It is easy to use and modify.

	This package is also very useful for beginners for learning Unity concepts, c# programming, Inspectors, State machine, Tweeners, particles, audio and a lot more.
	...
	Features:
		...
		• Tween animation with iTween, LeanTween, HOTween, DOTween.
	...
	http://ge-team.com/pages/unity-3d/first-chest/
